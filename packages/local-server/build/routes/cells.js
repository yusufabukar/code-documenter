...
const defaultCells_1 = require("./defaultCells");
;
    ...
    cellsRouter.get('/cells', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (error.code === 'ENOENT') {
                yield fs_1.promises.writeFile(fullPath, JSON.stringify(defaultCells_1.defaultCells), 'utf-8');
                const defaultFile = yield fs_1.promises.readFile(fullPath, { encoding: 'utf-8' });
